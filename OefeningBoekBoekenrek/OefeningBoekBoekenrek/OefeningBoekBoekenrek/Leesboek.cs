...
namespace OefeningBoekBoekenrek
{
    public class Leesboek: Boek
    {
        ...
        public Leesboek(string titel, string auteur, string eigenaar, decimal aankoopprijs,Genre genreNaam,Doelgroep doelgroep ,string onderwerp) : base(titel, auteur, eigenaar, aankoopprijs, genreNaam)
        {
            Onderwerp = onderwerp;
        }
